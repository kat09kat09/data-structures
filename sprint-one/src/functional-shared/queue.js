...
var queueMethods= {
  enqueue: function(value) {   
    ...
    console.log('my size after enqueue', this.size()); 
  ...
  dequeue: function () {
    ...
    console.log('my size after deque', this.size()); 
...
// var newQueue= new Queue; // someinstance obj  {enqueue, dequueu, size}
// newQueue.size(); // this: newQueue